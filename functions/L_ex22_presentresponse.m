function [startR, endR, keyCode] = L_ex22_presentresponse(subNo, w, IOI, pa_click, pa_target, pa_mask, maxResp, l_key, r_key, pause_key,  img_loc, img_tex, count, rhythmic)
...
%---------------------
WaitSecs(IOI); % pause before starting trial
